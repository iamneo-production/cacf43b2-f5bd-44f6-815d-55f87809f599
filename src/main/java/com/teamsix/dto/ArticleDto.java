...
public class ArticleDto {
	...
	public ArticleDto(Long srNo, String articleId, String title, String content, Status status,
			LocalDateTime creationDate, Date lastModifiedDate, Integer currentVersionId, UserDto user) {
		super();
		this.srNo = srNo;

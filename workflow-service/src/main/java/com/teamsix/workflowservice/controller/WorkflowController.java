...
//        }
    ...
    public ResponseEntity<?> changesByEditorToArticle(@RequestBody EditorChanges editorChanges, @PathVariable String articleId){
    ...
    @GetMapping("/editor/workflow/editorchanges/comment/{comment}/{articleId}/{editorChangeId}")

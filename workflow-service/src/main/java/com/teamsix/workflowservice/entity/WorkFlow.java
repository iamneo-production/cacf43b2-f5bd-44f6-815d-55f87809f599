...
public class WorkFlow {
    ...
    public WorkFlow(String id, String articleId, ArticleDto article, String editorUserId, String reviewerUserId, String submissionDate, String approvalDate, String rejectionReason, ReviewerFeedback reviewerFeedback, List<EditorChanges> editorChangesList) {
        this.id = id;
        this.articleId = articleId;
        this.article = article;
        this.editorUserId = editorUserId;
